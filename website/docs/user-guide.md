...
![Title screen](/docs/assets/user-guide/title.jpg)
...
![Game mode selection screen](/docs/assets/user-guide/mode-selection.jpg)
...
![Music selection screen](/docs/assets/user-guide/music-selection.jpg)
...
![Music selection screen](/docs/assets/user-guide/start-tutorial.jpg)
...
![Tutorial](/docs/assets/user-guide/tutorial.jpg)
...
![Music selection screen](/docs/assets/user-guide/chart-selection.jpg)
...
![Gameplay screen](/docs/assets/user-guide/gameplay.jpg)
...
![Gameplay screen, comparing speed 1.0x and 3.0x](/docs/assets/user-guide/speed.jpg)
...
![Result screen](/docs/assets/user-guide/result.jpg)
...
![Accuracy data in the result screen](/docs/assets/user-guide/accuracy-data.jpg)
...
![Options panel](/docs/assets/user-guide/options.jpg)
...
![Music selection screen, showing where to click the login button](/docs/assets/user-guide/how-to-login.jpg)

Create an account or log in:

![Login dialog](/docs/assets/user-guide/login.jpg)

When you are logged in, your play statistics are saved automatically,
and you can view them in the music selection screen:

![Music selection screen with recorded play stats](/docs/assets/user-guide/play-stats.jpg)

You can also find the ranking table in the ranking tab:

![Ranking table in each level](/docs/assets/user-guide/ranking.jpg)
