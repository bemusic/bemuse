          ...
          >
            {this.props.log ? (
              ...
              <div className='CustomBMSのdropzoneHint'>
                ...
                <input type="file" id="CustomBMSのdropzoneInput" className="CustomBMSのdropzoneInput" onChange={() => { this.handleFileSelect(document.getElementById('CustomBMSのdropzoneInput').files[0]) }} />
                <label htmlFor="CustomBMSのdropzoneInput" className='CustomBMSのdropzoneInputLabel'>Select File to Upload.</label>
              </div>
            )}
          </div>
        </div>
