        ...
        <section>
          <article>
            ...
            <p>
              ...
              good idea to have a cross-platform BMS player. It is also created
              to demonstrate the power of modern web technologies.
            </p>
            <p>
              ...
              available on{' '}
              <a href='https://github.com/bemusic/bemuse'>GitHub</a>.
            </p>
          ...
          <article>
            ...
            <p>
              ...
              Computer Enginnering, Faculty of Engineering, Kasetsart
              University, Thailand.
            </p>
            ...
            <p>
              <strong>Powered by open-source.</strong> Bemuse relies on many
              open source projects for development to make this possible.
            </p>
            <ul>
              <li>
                We use <a href='http://www.pixijs.com/'>Pixi.js</a>, which
                provides a super-fast graphics engine.
              </li>
              <li>
                We use <a href='https://facebook.github.io/react/'>React</a>, a
                library for building modular and composable user interfaces.
                React helps us build the UI more quickly than with traditional
                HTML and CSS.
              </li>
              <li>
                We use <a href='http://webpack.github.io/'>Webpack</a>, which
              ...
              <li>
                ...
                to be able to write our CSS more efficiently.
              </li>
              <li>
