...
  this screen. There are over 5,000 songs published in BMS format by the community worldwide. You can find them using
...
- **Keyboard mode** (7-keys). Play along with the music with your keyboard.
...
- **Adjustable turntable position.** You can put the turntable on the left or on the
  right (BMS mode only).
